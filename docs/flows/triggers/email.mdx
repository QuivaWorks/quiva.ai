...
<Tip>
If your forwarding address requires verification, triggering the verification email will start a flow which can be viewed in the monitor (under the flow menu on the left). By clicking on the logs, you can view the trigger details including the complete body of the received email which allows you to click the verification link. 
</Tip>
...
You can forward emails from your existing email address to the QuivaWorks email addresses. This allows you to use your branded email address (like support@yourcompany.com) while triggering QuivaWorks flows.
...
4. Enter your QuivaWorks trigger email address (e.g., `trigger+sparklyjollybubble650@quiva.ai`)
...
If your forwarding address requires verification, triggering the verification email will start a flow which can be viewed in the monitor (under the flow menu on the left). 

<Frame>
<img src="/images/flows/monitor-page.png" alt="View the monitor page to find emails that have triggered flows" />
</Frame>

By clicking on the logs, you can view the trigger details including the complete body of the received email which allows you to click the verification link. 

<Frame>
<img src="/images/flows/trigger-email-log.png" alt="Access the emal body to review and confirm the forwarding address" />
</Frame>
...
**Flow:**
- Trigger: Email (support@company.com forwards to QuivaWorks)
...
**Flow:**
- Trigger: Email (leads@company.com forwards to QuivaWorks)
...
**Flow:**
- Trigger: Email (invoices@company.com forwards to QuivaWorks)
...
**Flow:**
- Trigger: Email (orders@company.com forwards to QuivaWorks)
...
**Flow:**
- Trigger: Email (careers@company.com forwards to QuivaWorks)
...
**Flow:**
- Trigger: Email (subscribe@company.com forwards to QuivaWorks)
...
**Flow:**
- Trigger: Email (feedback@company.com forwards to QuivaWorks)
...
**Flow:**
- Trigger: Email (approvals@company.com forwards to QuivaWorks)
...
**Verify trigger addresses:** Ensure you're sending to the correct QuivaWorks address (draft or published).
