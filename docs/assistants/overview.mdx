...
[Learn more about Context Variables →](/assistants/configuration/context-settings)
...
- **Bring Your Own Keys** — Connect Anthropic, OpenAI, or Google AI keys on Team and Enterprise plans
...
<CardGroup cols={2}>
  ...
  <Card title="Context Variables" icon="sliders" href="/assistants/configuration/context-settings">
